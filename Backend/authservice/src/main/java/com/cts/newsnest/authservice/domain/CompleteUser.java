...
//    @NotBlank(message = "Password is mandatory")
    ...
    public CompleteUser(String firstName, String lastName, String email, String phoneNumber, String password) {
...
//    public CompleteUser(int id, String firstName, String lastName, String email, String phoneNumber, String password) {
//        this.id = id;
//        this.firstName = firstName;
//        this.lastName = lastName;
//        this.email = email;
